...
public class Default_VarPin {
	...
	while (pinSystem >= -30.0f) {
	    ...
	    SimulationSetup simSet = new SimSetAMPVOA(numberCh, pinSystem, 9.0f, 2, 18);
	...
	System.out.printf("%2.3f\t%2.3f\t%2.3f\t%2.3f", nfMetric.evaluate(amplifiers), gnliMetric.getTiltOSNR_NLI(), gnliMetric.worstOSNR_NLI(),
