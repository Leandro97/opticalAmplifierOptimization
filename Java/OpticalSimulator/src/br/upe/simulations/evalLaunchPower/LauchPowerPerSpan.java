...
/***
 * Gerar 30 solu��es com melhor OSNR Extrair pot�ncia de lan�amento de cada span
 * Plotar gr�fico: pot�ncia de lan�amento vs. Posi��o span Fazer para 3 e
...
public class LauchPowerPerSpan {
	...
	AmplifierType ampType = AmplifierType.EDFA_1;
