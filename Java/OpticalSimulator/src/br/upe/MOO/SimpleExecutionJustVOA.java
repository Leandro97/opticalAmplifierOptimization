...
public class SimpleExecutionJustVOA {
	...
	for (int run = 0; run < 100; run++) {
	    ...
	    NondominatedPopulation result = new Executor().withProblemClass(ACOPProblem_JustVOA.class, 2,
		    AmplifierType.EDFA_1, ACOP_LOCAL_PROBLEM.AdGC).withAlgorithm("NSGAII")
